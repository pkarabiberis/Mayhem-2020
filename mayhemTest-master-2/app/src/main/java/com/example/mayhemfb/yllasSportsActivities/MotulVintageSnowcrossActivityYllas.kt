...
import kotlinx.android.synthetic.main.activity_motul_snowcross_yllas.*
import kotlinx.android.synthetic.main.activity_motul_vintage_snowcross_yllas.*
...
class MotulVintageSnowcrossActivityYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_motul_vintage_snowcross_yllas)
        ...
        val motulVintageSnowCross = yllas.collection("Sports").document("motul-vintage-snowcross")
        val sportTime = yllas.collection("Timetables").document("motul-vintage-snowcross")
        ...
        motulVintageSnowCross.collection("results")
            .orderBy("time", Query.Direction.ASCENDING)
            .get()
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    val emptyScoreText = "No results yet."
                    emptyScore_motulVintage_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutMotulVintage_yllas.addView(caption)
                    }
