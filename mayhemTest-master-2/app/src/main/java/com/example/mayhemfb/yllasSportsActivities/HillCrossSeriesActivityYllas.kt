...
import kotlinx.android.synthetic.main.activity_hillclimb_yllas.*
...
class HillCrossSeriesActivityYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hillcross_yllas)
        ...
        val hillCross = yllas.collection("Sports").document("hillcross-series")
        val sportTime = yllas.collection("Timetables").document("hillcross-series")
        ...
        hillCross.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_hillCross_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutHillcross_yllas.addView(caption)
                    }
