...
class ScottHillClimbActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hillclimb)
        ...
        val hillClimb = luosto.collection("Sports").document("scott-hillclimb-series")
        val sportTime = luosto.collection("Timetables").document("scott-hillclimb-series")
        ...
        hillClimb.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_Hillclimb.text = emptyScoreText
                } else {
