...
import kotlinx.android.synthetic.main.activity_hillcross.captionsLayout
import kotlinx.android.synthetic.main.results_layout.*
import kotlinx.android.synthetic.main.results_layout.view.*
import kotlinx.android.synthetic.main.results_layout.view.scoresPosition_textView
import kotlinx.android.synthetic.main.testerihorizontalresults.view.*

class HillCrossSeriesActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hillcross)
        ...
        val hillCross = luosto.collection("Sports").document("hillcross-series")
        val sportTime = luosto.collection("Timetables").document("hillcross-series")
        ...
        hillCross.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_HillCross.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayout.addView(caption)
                    }
