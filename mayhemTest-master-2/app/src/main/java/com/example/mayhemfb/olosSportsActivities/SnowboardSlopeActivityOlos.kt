...
class SnowboardSlopeActivityOlos : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_snowboard_slope_olos)
        ...
        val snowboard_slopeStyle = olos.collection("Sports").document("snowboard-slopestyle")
        val sportTime = olos.collection("Timetables").document("snowboard-slopestyle")
        ...
        snowboard_slopeStyle.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_snowboard_slope_olos.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutSnowboard_olos.addView(caption)
                    }
