...
class SkiSlopeStyleActivityYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_slopestyle_yllas)
        ...
        val slopeStyle = yllas.collection("Sports").document("ski-slopestyle")
        val sportTime = yllas.collection("Timetables").document("ski-slopestyle")
        ...
        slopeStyle.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_slopestyle_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutSlope_yllas.addView(caption)
                    }
