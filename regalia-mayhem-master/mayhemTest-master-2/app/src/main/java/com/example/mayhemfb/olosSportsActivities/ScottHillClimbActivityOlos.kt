...
class ScottHillClimbActivityOlos : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hillclimb_olos)
        ...
        val hillClimb = olos.collection("Sports").document("scott-hillclimb-series")
        val sportTime = olos.collection("Timetables").document("scott-hillclimb-series")
        ...
        hillClimb.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_Hillclimb_olos.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutHillclimb_olos.addView(caption)
                    }
