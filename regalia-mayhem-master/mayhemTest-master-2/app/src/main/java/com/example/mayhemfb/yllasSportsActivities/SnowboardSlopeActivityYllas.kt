...
import kotlinx.android.synthetic.main.activity_slopestyle_yllas.*
import kotlinx.android.synthetic.main.activity_snowboard_slope.*
import kotlinx.android.synthetic.main.activity_snowboard_slope.timeSnowboard
import kotlinx.android.synthetic.main.activity_snowboard_slope_yllas.*
...
class SnowboardSlopeActivityYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_snowboard_slope_yllas)
        ...
        val snowboard_slopeStyle = yllas.collection("Sports").document("snowboard-slopestyle")
        val sportTime = yllas.collection("Timetables").document("snowboard-slopestyle")
        ...
        snowboard_slopeStyle.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScore_snowboard_slope_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutSnowboard_yllas.addView(caption)
                    }
