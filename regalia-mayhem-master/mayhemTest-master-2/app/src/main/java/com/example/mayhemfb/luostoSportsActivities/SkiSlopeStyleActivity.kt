...
class SkiSlopeStyleActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_slopestyle)
        ...
        val slopeStyle = luosto.collection("Sports").document("ski-slopestyle")
        val sportTime = luosto.collection("Timetables").document("ski-slopestyle")
        ...
        slopeStyle.collection("results")
            ...
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    ...
                    emptyScoreSlope.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutSlope_luosto.addView(caption)
                    }
