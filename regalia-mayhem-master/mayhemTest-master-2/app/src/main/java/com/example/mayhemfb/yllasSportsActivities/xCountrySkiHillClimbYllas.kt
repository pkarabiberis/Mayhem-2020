...
import kotlinx.android.synthetic.main.activity_hillcross_yllas.*
import kotlinx.android.synthetic.main.activity_xcountry_yllas.*
...
class xCountrySkiHillClimbYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_xcountry_yllas)
        ...
        val xCountry = yllas.collection("Sports").document("x-country-ski-hillclimb")
        val sportTime = yllas.collection("Timetables").document("x-country-ski-hillclimb")
        ...
        xCountry.collection("results")
            .orderBy("time", Query.Direction.ASCENDING)
            .get()
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    val emptyScoreText = "No results yet."
                    emptyScore_xCountry_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutxCountry_yllas.addView(caption)
                    }
