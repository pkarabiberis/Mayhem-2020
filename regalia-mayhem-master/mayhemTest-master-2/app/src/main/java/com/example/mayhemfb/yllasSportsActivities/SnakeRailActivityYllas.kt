...
import kotlinx.android.synthetic.main.activity_snake_rail_yllas.*
...
class SnakeRailActivityYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_snake_rail_yllas)
        ...
        val snakeRail = yllas.collection("Sports").document("snake-rail")
        val sportTime = yllas.collection("Timetables").document("snake-rail")
        ...
        sportTime
            ...
            .addOnSuccessListener { documents ->
                ...
                if (startTime != null && endTime != null) {
                   timeTextView.text = startTime.toString() + " - " + endTime.toString()
                }
            }

        snakeRail.collection("results")
            .orderBy("time", Query.Direction.ASCENDING)
            .get()
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    val emptyScoreText = "No results yet."
                    emptyScore_snakerail_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutSnakerail_yllas.addView(caption)
                    }
