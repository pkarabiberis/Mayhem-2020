...
import kotlinx.android.synthetic.main.activity_banked_slalom_yllas.*
...
class MotulSnowcrossActivityYllas : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_motul_snowcross_yllas)
        ...
        val motulSnowCross = yllas.collection("Sports").document("motul-snowcross")
        val sportTime = yllas.collection("Timetables").document("motul-snowcross")
        ...
        motulSnowCross.collection("results")
            .orderBy("time", Query.Direction.ASCENDING)
            .get()
            .addOnSuccessListener { documents ->
                if (documents.isEmpty) {
                    val emptyScoreText = "No results yet."
                    emptyScore_motul_yllas.text = emptyScoreText
                } else {
                    for (title in captions) {
                        ...
                        captionsLayoutMotul_yllas.addView(caption)
                    }
